                                                    ...
                                                    .exec(function (err, docs) {
                                                        if (err) {
                                                            ...
                                                            if (result <= seatnum && result !== 0) {
                                                                prob1 = (100 - 20 * (result - 1) / (seatnum - 1)) * RANK_WEIGHT / 100;
                                                            }
                                                            else {
                                                                var tmp = (80 - 8 * Math.pow((result - seatnum), 2));
                                                                if (tmp < 10) {
                                                            ...
                                                            chartDataModel.find({auctionID: auctionid}, function (err, docs) {
                                                                if (err) {
                                                                    ...
                                                                    if (price > base) {
                                                                        prob2 = (80 + 20 * (price - base) / base) * PRICE_WEIGHT / 100;
                                                                    }
                                                                    else {
                                                                        var tmp = 80 - Math.floor(base / 100) * (base - price) / 50;
                                                                        if (tmp <= 10) {
                                                                    ...
                                                                    auctionParamModel.find({auctionID: auctionid}, function (err, docs) {
                                                                        if (err) {
                                                                            ...
                                                                            console.log("TMP1: " + prob1);
                                                                            console.log("TMP2: " + prob2);
                                                                            console.log("TMP3: " + prob3);
